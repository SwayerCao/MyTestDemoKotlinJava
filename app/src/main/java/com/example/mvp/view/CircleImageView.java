...
public class CircleImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    private int mBackgroundColor = DEFAULT_CIRCLE_BACKGROUND_COLOR;
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBackgroundColor = a.getColor(R.styleable.CircleImageView_civ_bg_color,DEFAULT_CIRCLE_BACKGROUND_COLOR);
